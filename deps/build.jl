  ...
  if is_linux()
    try
      ...
      if BinDeps.can_use(AptGet)
        printrun(`sudo apt-get -y install cmake cmake-data qtdeclarative5-dev qml-module-qtquick-controls qml-module-qtquick-dialogs qml-module-qt-labs-folderlistmodel qml-module-qt-labs-settings qmlscene qt5-default libqt5svg5-dev`)
...
cmake_prefix *= (cmake_prefix == "" ? "" : ";")*jlcxx_dir
